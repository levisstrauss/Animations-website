...
const Wrapper = styled.div`
  ...
  *, & {
    transition: 1s cubic-bezier(0.075, 0.82, 0.165, 1); //0.2s to start the transition
  }
...
const IconWrapper = styled.div`
  ...
  border-radius: 50%;
  display: grid;
  justify-content: center;  // start => left center => middle end=> right 
  align-content: center;  // start => top end => bottom
  justify-self: center;
  position: relative;
